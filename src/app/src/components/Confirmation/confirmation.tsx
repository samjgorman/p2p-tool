...
function Confirmation(props){
    ...
    function handleConfirmation(){
        ...
        // window.Main.ifConnectionConfirmed(ifConnectionConfirmed)
    ...
    return(
       ...
       {dataReceived && 
        <React.Fragment>
       <div className="InvitedBy"> {invitedBy} has invited you to chat on p2p-chat. </div>
       <div className="InviteInfo"> If you decide to accept, a secure connection will be formed and you will be able to chat. </div>
